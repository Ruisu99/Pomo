...
const en: Dict = {
  ...
  ambient_title: "Focus radio",
  ambient_desc: "Live lo-fi radio stream — press play to focus.",
  ambient_play: "Play stream",
  ambient_pause: "Pause stream",
  ambient_volume: "Volume",
  ambient_lofi: "Lofi Hip-Hop",
  ambient_jazz: "Lofi Jazz",
  ambient_rain: "Rain",
  ambient_cafe: "Café",
  ...
  focus_mode_bullet_auto: "Auto-starts and advances work ↔ breaks",
  focus_mode_bullet_strict: "Locks pause / skip / reset during work (optional in Settings)",
  focus_mode_bullet_block: "Blocks distracting sites via the browser extension (optional)",
  ...
  settings_background_pixel: "Pixel city",
...
const de: Dict = {
  ...
  ambient_title: "Focus-Radio",
  ambient_desc: "Live Lo-Fi Radio — Play drücken und fokussieren.",
  ambient_play: "Stream abspielen",
  ambient_pause: "Stream pausieren",
  ...
  settings_background_gold: "Gold",
  settings_background_pixel: "Pixel-Stadt",
  ...
  focus_mode_desc: "Auto-Zyklus + optionale Seitenblockierung.",
  focus_mode_active:
  ...
  focus_mode_bullet_auto: "Startet und wechselt automatisch Arbeit ↔ Pause",
  focus_mode_bullet_strict: "Sperrt Pause / Skip / Reset während der Arbeit (optional in Einstellungen)",
  focus_mode_bullet_block: "Blockiert Ablenkungsseiten über die Browser-Erweiterung (optional)",
  focus_strict_hint:
